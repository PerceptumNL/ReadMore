...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ArticleRatingItem', fields ['user']
        db.delete_unique(u'main_articleratingitem', ['user_id'])

        # Removing unique constraint on 'ArticleHistoryItem', fields ['user']
        db.delete_unique(u'main_articlehistoryitem', ['user_id'])

        # Removing unique constraint on 'ArticleDifficultyItem', fields ['user']
        db.delete_unique(u'main_articledifficultyitem', ['user_id'])

        # Removing unique constraint on 'WordHistoryItem', fields ['user']
        db.delete_unique(u'main_wordhistoryitem', ['user_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'WordHistoryItem', fields ['user']
        db.create_unique(u'main_wordhistoryitem', ['user_id'])

        # Adding unique constraint on 'ArticleDifficultyItem', fields ['user']
        db.create_unique(u'main_articledifficultyitem', ['user_id'])

        # Adding unique constraint on 'ArticleHistoryItem', fields ['user']
        db.create_unique(u'main_articlehistoryitem', ['user_id'])

        # Adding unique constraint on 'ArticleRatingItem', fields ['user']
        db.create_unique(u'main_articleratingitem', ['user_id'])
