...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PilotSignup'
        db.create_table(u'main_pilotsignup', (
            ...
            ('signup', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'main', ['PilotSignup'])


    def backwards(self, orm):
        # Deleting model 'PilotSignup'
        db.delete_table(u'main_pilotsignup')
    ...
    models = {
        ...
        u'main.group': {
            ...
            'leader': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'teaches'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'main.history': {
        ...
        u'main.pilotsignup': {
            ...
            'signup': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        u'main.statistics': {
