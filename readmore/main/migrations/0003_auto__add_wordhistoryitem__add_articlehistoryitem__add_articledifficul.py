...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WordHistoryItem'
        db.create_table(u'main_wordhistoryitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Article'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('word', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'main', ['WordHistoryItem'])

        # Adding model 'ArticleHistoryItem'
        db.create_table(u'main_articlehistoryitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Article'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'main', ['ArticleHistoryItem'])

        # Adding model 'ArticleDifficultyItem'
        db.create_table(u'main_articledifficultyitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Article'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
        ...
        db.send_create_signal(u'main', ['ArticleDifficultyItem'])

        # Adding model 'ArticleRatingItem'
        db.create_table(u'main_articleratingitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Article'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('rating', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal(u'main', ['ArticleRatingItem'])


    def backwards(self, orm):
        # Deleting model 'WordHistoryItem'
        db.delete_table(u'main_wordhistoryitem')

        # Deleting model 'ArticleHistoryItem'
        db.delete_table(u'main_articlehistoryitem')

        # Deleting model 'ArticleDifficultyItem'
        db.delete_table(u'main_articledifficultyitem')

        # Deleting model 'ArticleRatingItem'
        db.delete_table(u'main_articleratingitem')
    ...
    models = {
        ...
        u'main.articledifficultyitem': {
            'Meta': {'ordering': "['date']", 'object_name': 'ArticleDifficultyItem'},
        ...
        u'main.articlehistoryitem': {
            'Meta': {'ordering': "['date']", 'object_name': 'ArticleHistoryItem'},
            'article': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.Article']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        ...
        u'main.articleratingitem': {
            'Meta': {'ordering': "['date']", 'object_name': 'ArticleRatingItem'},
            'article': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.Article']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rating': ('django.db.models.fields.IntegerField', [], {}),
        ...
        u'main.wordhistoryitem': {
            'Meta': {'ordering': "['date']", 'object_name': 'WordHistoryItem'},
            'article': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.Article']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
