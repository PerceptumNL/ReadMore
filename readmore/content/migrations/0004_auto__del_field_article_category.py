...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'content_article', 'category_id')


    def backwards(self, orm):
        # Adding field 'Article.category'
        db.add_column(u'content_article', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['content.Category']),
                      keep_default=False)
