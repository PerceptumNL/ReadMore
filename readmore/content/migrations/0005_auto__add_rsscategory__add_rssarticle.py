...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RSSCategory'
        db.create_table(u'content_rsscategory', (
        ...
        db.send_create_signal(u'content', ['RSSCategory'])

        # Adding model 'RSSArticle'
        db.create_table(u'content_rssarticle', (
        ...
        db.send_create_signal(u'content', ['RSSArticle'])


    def backwards(self, orm):
        # Deleting model 'RSSCategory'
        db.delete_table(u'content_rsscategory')

        # Deleting model 'RSSArticle'
        db.delete_table(u'content_rssarticle')
