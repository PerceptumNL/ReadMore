...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'KidsWeekCategory'
        db.delete_table(u'content_kidsweekcategory')

        # Deleting model 'SevenDaysArticle'
        db.delete_table(u'content_sevendaysarticle')

        # Deleting model 'SevenDaysCategory'
        db.delete_table(u'content_sevendayscategory')


    def backwards(self, orm):
        # Adding model 'KidsWeekCategory'
        db.create_table(u'content_kidsweekcategory', (
        ...
        db.send_create_signal(u'content', ['KidsWeekCategory'])

        # Adding model 'SevenDaysArticle'
        db.create_table(u'content_sevendaysarticle', (
            ...
            ('identifier', self.gf('django.db.models.fields.URLField')(max_length=255)),
        ))
        db.send_create_signal(u'content', ['SevenDaysArticle'])

        # Adding model 'SevenDaysCategory'
        db.create_table(u'content_sevendayscategory', (
            ('feed', self.gf('django.db.models.fields.URLField')(max_length=200)),
            (u'category_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['content.Category'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'content', ['SevenDaysCategory'])
