...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DocumentProcessed'
        db.create_table(u'content_documentprocessed', (
        ...
        db.send_create_signal(u'content', ['DocumentProcessed'])


    def backwards(self, orm):
        # Deleting model 'DocumentProcessed'
        db.delete_table(u'content_documentprocessed')
    ...
    models = {
        ...
        u'content.documentprocessed': {
            'Meta': {'object_name': 'DocumentProcessed'},
