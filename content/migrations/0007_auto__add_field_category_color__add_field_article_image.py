...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'content_category', 'color',
                      self.gf('django.db.models.fields.CharField')(default='#f3f3f3', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Article.image'
        db.add_column(u'content_article', 'image',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'content_category', 'color')

        # Deleting field 'Article.image'
        db.delete_column(u'content_article', 'image')
