...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'content_contentsource', (
        ...
        db.send_create_signal(u'content', ['ContentSource'])

        # Adding field 'Article.source'
        db.add_column(u'content_article', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.ContentSource'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.source'
        db.add_column(u'content_category', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.ContentSource'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'content_contentsource')

        # Deleting field 'Article.source'
        db.delete_column(u'content_article', 'source_id')

        # Deleting field 'Category.source'
        db.delete_column(u'content_category', 'source_id')
    ...
    models = {
        ...
        u'content.kidsweekcategory': {
            'Meta': {'object_name': 'KidsWeekCategory', '_ormbases': [u'content.Category']},
        ...
        u'content.sevendaysarticle': {
            'Meta': {'object_name': 'SevenDaysArticle', '_ormbases': [u'content.Article']},
            u'article_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['content.Article']", 'unique': 'True', 'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.URLField', [], {'max_length': '255'}),
            'publication_date': ('django.db.models.fields.DateTimeField', [], {})
        },
        u'content.sevendayscategory': {
            'Meta': {'object_name': 'SevenDaysCategory', '_ormbases': [u'content.Category']},
            u'category_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['content.Category']", 'unique': 'True', 'primary_key': 'True'}),
            'feed': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        },
