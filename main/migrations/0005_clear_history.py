...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.ArticleHistoryItem.objects.all().delete()
        orm.WordHistoryItem.objects.all().delete()
        orm.ArticleRatingItem.objects.all().delete()
        orm.ArticleDifficultyItem.objects.all().delete()
