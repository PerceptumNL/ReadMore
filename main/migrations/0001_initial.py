    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_to_listen_to', models.CharField(max_length=255, choices=[(b'docsRead', b'docsRead')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge', models.ForeignKey(related_name='counter_badges', to='main.Badge')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(related_name='statistics', to=settings.AUTH_USER_MODEL, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('badges', models.ManyToManyField(related_name='users', to='main.Badge', blank=True)),
                ('groups', models.ManyToManyField(related_name='users', to='main.Group', blank=True)),
                ('institute', models.ForeignKey(related_name='users', blank=True, to='main.Institute', null=True)),
                ('user', models.OneToOneField(to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='ArticleDifficultyItem',
            fields=[
                ('event_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='main.Event')),
        ...
        migrations.AddField(
            model_name='group',
            name='institute',
            field=models.ForeignKey(blank=True, to='main.Institute', null=True),
        ),
        migrations.AddField(
            model_name='group',
            name='leader',
            field=models.ForeignKey(related_name='teaches', blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='event',
            name='polymorphic_ctype',
            field=models.ForeignKey(related_name='polymorphic_main.event_set+', editable=False, to='contenttypes.ContentType', null=True),
        ),
        migrations.AddField(
            model_name='event',
            name='user',
